...
foreach(CONAN_BUILD_TYPE IN LISTS CONAN_BUILD_TYPES)
    ...
    list(APPEND CONAN_ARGS "--output-folder=${CONAN_INSTALL_FOLDER}")
    list(APPEND CONAN_ARGS "--build" "missing")
    list(APPEND CONAN_ARGS "-s" "build_type=${CONAN_BUILD_TYPE}" "-pr:b=default")
